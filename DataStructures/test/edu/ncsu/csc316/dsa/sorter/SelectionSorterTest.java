...
/**
 * Test the SelectionSorter class.
 * 
 * @author Dr. King
 * @author Maggie Lin
 */
public class SelectionSorterTest {
	...
	/** SelectionSorter for Integers */
	private SelectionSorter<Integer> integerSorter;
	
	/** SelectionSorter for Students */
	...
	/**
	 * Sets up the Integer SelectionSorter, StudentIDComparator, and Student SelectionSorter.
	 */
	@Before
	public void setUp() {
		integerSorter = new SelectionSorter<Integer>();
		StudentIDComparator idComp = new StudentIDComparator();
		studentSorter = new SelectionSorter<Student>(idComp);
	}

	/**
	 * Test whether Integer SelectionSorter is sorting Integers into ascending order.
	 */
	@Test
	...
	/**
	 * Test whether Student SelectionSorter is sorting Students into ascending order based on ID.
	 */
	@Test
