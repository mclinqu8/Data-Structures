...
/**
 * Test whether Insertion Sort is working
 * 
 * @author Dr. King
 * @author Maggie Lin
 */
public class InsertionSorterTest {
	...
	/** InsertionSorter for Integers */
	private InsertionSorter<Integer> integerSorter;
	
	/** InsertionSorter for Students */
	...
	/**
	 * Sets up the Integer InsertionSorter, StudentIDComparator, and Student InsertionSorter.
	 */
	@Before
	public void setUp() {
		integerSorter = new InsertionSorter<Integer>();
		StudentIDComparator idComp = new StudentIDComparator();
		studentSorter = new InsertionSorter<Student>(idComp);
	}

	/**
	 * Test whether Integer InsertionSorter is sorting Integers into ascending order.
	 */
	@Test
	...
	/**
	 * Test whether Student InsertionSorter is sorting Students into ascending order based on ID.
	 */
	@Test
