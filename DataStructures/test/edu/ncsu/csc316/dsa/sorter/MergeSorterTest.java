...
public class MergeSorterTest {
	...
	/** MergeSorter for Integers */
	private MergeSorter<Integer> integerSorter;
	
	/** MergeSorter for Students */
	...
	/**
	 * Sets up the Integer MergeSorter, StudentIDComparator, and Student MergeSorter.
	 */
	@Before
	public void setUp() {
		integerSorter = new MergeSorter<Integer>();
		StudentIDComparator idComp = new StudentIDComparator();
		studentSorter = new MergeSorter<Student>(idComp);
	}

	/**
	 * Test whether Integer MergerSorter is sorting Integers into ascending order.
	 */
	@Test
	...
	/**
	 * Test whether Student MergeSorter is sorting Students into ascending order based on ID.
	 */
	@Test
