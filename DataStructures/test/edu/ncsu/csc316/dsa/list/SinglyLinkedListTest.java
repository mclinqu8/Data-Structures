 ...
 * abstract data type behaviors when using an linked-list data structure
 *
 * @author Dr. King
 * @author Maggie Lin
 *
...
public class SinglyLinkedListTest {
	...
	/**
	 * Create a new instance of an SinglyLinkedList before each test case executes
	 */
	@Before
	public void setUp() {
	...
	public void testIterator() {
		...
		// Create an iterator for the list that has 2 element
		it = list.iterator();

		// Try different iterator operations to make sure they work
		// as expected for a list that contains 2 element (at this point)
		assertTrue(it.hasNext());
		assertEquals("one", it.next());
		assertTrue(it.hasNext());
	...
	/**
	 * Test the output of the setElement() behavior, including expected exceptions
	 */
	@Test
