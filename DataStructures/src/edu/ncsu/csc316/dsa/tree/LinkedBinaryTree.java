 ...
 * algorithm listed under Java Implementation of a Linked Binary Tree Structure
 * on page 323 - 328 in the course textbook "Data Structures and Algorithms" by
...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
	 ...
	 */
	@Override
	public Position<E> addLeft(Position<E> p, E value) throws IllegalArgumentException {
		BinaryTreeNode<E> node = validate(p);
		if (left(node) != null) {
	...
	/**
	 * Set the given position to be the root of the tree
	 * 
	 * @param p the position for which to set as root
