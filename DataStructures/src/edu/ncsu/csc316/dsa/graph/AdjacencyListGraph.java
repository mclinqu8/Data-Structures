...
public class AdjacencyListGraph<V, E> extends AbstractGraph<V, E> {
    ...
    public Edge<E> insertEdge(Vertex<V> v1, Vertex<V> v2, E edgeData) {
        ...
        Position<Edge<E>> pos1 = origin.getOutgoing().addLast(edge);
        edge.setOutgoingListPosition(pos1);
        Position<Edge<E>> pos2 = destination.getIncoming().addLast(edge);
        edge.setIncomingListPosition(pos2);
        return edge;
    }
     ...
     * 
     * @param v vertex to cast to an adjacency list vertex
     ...
     * 
     * @param e edge to cast to an adjacency list edge
