...
public class EdgeListGraph<V, E> extends AbstractGraph<V, E> {
    ...
    /**
     * Check to see if the given vertex is a valid edge list vertex
     * 
     * @param v given vertex to validate
     * @return whether the given vertex is a valid edge list vertex
     */
    ...
    /**
     * Returns a list of edges with the given vertex as the outgoing vertex
     * 
     * @param vertex the outgoing vertex of edges 
     * @return list of edges with the given vertex as the outgoing vertex
     */
    ...
    /**
     * Returns a list of edges with the given vertex as the incoming vertex
     * 
     * @param vertex the incoming vertex of edges 
     * @return list of edges with the given vertex as the incoming vertex
     */
