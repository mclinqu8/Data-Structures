...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
	 ...
	 * 
	 * @param compare the comparator to use instead of the default
	 */
...
//		return tree.toString();
		...
		Iterable<Entry<K, V>> collection = this.entrySet();
		Iterator<Entry<K, V>> entryIt = collection.iterator();
		while (entryIt.hasNext()) {
			sb.append(entryIt.next().getKey());
			sb.append(" \n");
		}
		sb.append("]");
		return sb.toString();
...
//	}
	...
	protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
		...
		public void rotate(Position<Entry<K, V>> p) {
			...
			// re-link the parent and nod and transfer node's subtree
		...
		public Position<Entry<K, V>> restructure(Position<Entry<K, V>> x) {
			...
			if (current == parent.getLeft() && parent == grandparent.getLeft()
					|| current == parent.getRight() && parent == grandparent.getRight()) {
				rotate(parent);
				return parent;
			} else {
		...
		protected static class BSTNode<E> extends BinaryTreeNode<E> {
			...
			/** The additional information contained in a node */
	 ...
	 * @return the parent of the position specified
	 */
	...
	/**
	 * Return whether the position is an internal node
	 * 
	 * @param p the position to look at
	 * @return whether the position is an internal node of the tree
	 */
	...
	/**
	 * Return the original entry in the position
	 * 
	 * @param p the position to set
	 * @param entry the new entry to set at the given position
	 * @return the entry that was replaced by the new entry
	 */
	...
	/**
	 * Return whether the position is a leaf node
	 * 
	 * @param p the position to look at
	 * @return whether the position is a leaf node of the tree
	 */
	...
	/**
	 * Return whether the position is the root
	 * 
	 * @param p the position to look at
	 * @return whether the position is the root of the tree
	 */
	...
	/**
	 * Return the position of the left child of the provided position
	 * 
	...
	/**
	 * Return the position of the right child of the provided position
	 * 
	 * @param p the given position
	...
	/**
	 * Return the position of the sibling of the provided position
	 * 
	 * @param p the given position
