...
/**
 * The TreeSet is implemented as an AVL Tree data structure to support efficient
 * set abstract data type behaviors.
 * 
 * Using a AVL tree ensures worst-case runtime of O(logn) for (@link Set#add),
 * (@link Set#remove), and (@link Set#contains); O(nlogn) worst-case runtime for
 * (@link Set#addAll), (@link Set#removeAll), and (@link Set#retainAll); and
 * O(1) worst-case runtime for (@link Set#size) and (@link Set#isEmpty).
 * 
